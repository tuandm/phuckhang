...
class MY_SCPostManage extends WP_List_Table
{
    ...
    function prepare_items()
    {
        ...
        $this->foundData = new WP_Query($args);
        $current_page = $this->get_pagenum();
        $totalItems = $this->foundData->found_posts;
        $this->foundData->posts = array_slice($this->foundData->posts, (($current_page - 1) * PERPAGE), PERPAGE);
